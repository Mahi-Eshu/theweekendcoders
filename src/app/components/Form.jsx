    ...
    <div className='max-w-[1100px] mx-auto pb-10 flex flex-col gap-10'>
        ...
        <div className='flex flex-col gap-10 lg:flex-row lg:justify-between'>
            ...
            <div className='flex flex-col gap-2'>
                ...
                <select name="profession" id="profession" className='backdrop-blur-md bg-black/20 p-3 lg:w-[450px] h-[60px] border-b-2 rounded-sm border-white '>
        ...
        <div className='flex flex-col gap-2'>
            ...
            <label htmlFor='requirement' className='text-2xl font-medium tracking-tighter'>You're Interested In</label>
                <select name="requirement" id="requirement" className='backdrop-blur-md bg-black/20 p-3 lg:w-[450px] h-[60px] border-b-2 rounded-sm border-white '>
